...
Route::name('admin.')->namespace('Admin')->middleware(['auth:web', 'check.status'])->group(function () {
    ...
    Route::get('api/task/board', 'TaskController@getAll')->name('tasks.get');
    Route::post('api/task/columns/new', 'TaskController@createColumn')->name('tasks.createColumn');
    Route::post('api/task/columns/update', 'TaskController@updateColumn')->name('tasks.updateColumn');
    Route::post('api/task/columns/delete', 'TaskController@deleteColumn')->name('tasks.deleteColumn');

    Route::post('api/task/tasks/new', 'TaskController@createTask')->name('tasks.createTask');
    Route::post('api/task/tasks/edit', 'TaskController@editTask')->name('tasks.editTask');
    Route::post('api/task/tasks/delete', 'TaskController@deleteTask')->name('tasks.deleteTask');
