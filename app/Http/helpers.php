...
if (! function_exists('CopyRight')) {
    function CopyRight() {
        ...
        if($copyrightStartDate) {
            $copyright = "<span>".trans('site.copyright')." © ". $copyrightStartDate . " <b>" .request()->getHost()."</b> ".trans('site.designed_by')." <a href='https://wa.me/966594255775'>Abdullah Alameri</a> ".trans('site.all_rights_reserved')."</span>";
        }
